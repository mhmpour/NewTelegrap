...
public class BuildVars {
    ...
    public static int BUILD_VERSION = 0x12bac;
    ...
    public static String HOCKEY_APP_HASH_DEBUG_SECRET= "3e5111b276824839b8147f673a74d1e0";
    public static String HOCKEY_APP_HASH_DEBUG = "3e5111b276824839b8147f673a74d1e0";
    public static String GCM_SENDER_ID = "760348033672";
    public static String SEND_LOGS_EMAIL = "mhmpour@gmail.com";
    ...
    public static String FOURSQUARE_API_VERSION = "20170202";
    public BuildVars()
    {
    }
}
